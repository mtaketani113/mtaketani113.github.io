...
特定環境でDocker Desktop for Windowsを使っていて  
3回ほど動かなくて試行錯誤したので、まとめます。

前提として、そこではProxy環境下で作業しています。  
また、PCは半年～1年くらい世間から遅れたバージョンを使っています。  
よくありますよね。  
...
次にメンバーが、Docker Desktopを入れるとなぜか今度は起動すらしない。  
...
環境が異なると自宅のPCとは状況が違うので  
家で試したら何もなく動くのに、別のところだと動かないとか、  
よくありますよね( ;∀;)  
ほんと難しい。。
